  ...
  return (
    <div className="flex justify-center">
      <div className="container flex flex-col space-y-8 mt-4">
        ...
        <h1 className="text-bold text-4xl">
          Privacy Policy of MIDDLEGROUND LLC
        </h1>
        <p>
          The MiddleGround team operates the MiddleGround.college website, which provides
          the application service.
        </p>
        <p>
          This page is used to inform website visitors regarding our policies
          with the collection, use, and disclosure of Personal Information if
          anyone decided to use our Service, the MiddleGround website.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at MiddleGround.college,
          unless otherwise defined in this Privacy Policy.
        </p>
        <h1 className="text-bold text-4xl">Information Collection and Use</h1>
        <p>
        ...
        <h1 className="text-bold text-4xl">Log Data</h1>
        <p>
        ...
        <h1 className="text-bold text-4xl">Cookies</h1>
        <p>
        ...
        <h1 className="text-bold text-4xl">Service Providers</h1>
        <p>
        ...
        <h1 className="text-bold text-4xl">Security</h1>
        <p>
        ...
        <h1 className="text-bold text-4xl">Links to Other Sites</h1>
        <p>
        ...
        <h1 className="text-bold text-4xl">Children's Privacy</h1>
        <p>
        ...
        <h1 className="text-bold text-4xl">Changes to This Privacy Policy</h1>
        <p>
        ...
        <h1 className="text-bold text-4xl">Contact Us</h1>
        <p>
          If you have any questions or suggestions about our Privacy Policy, do
          not hesitate to contact us.
        </p>
        <div>
          <h1 className="text-bold text-4xl">Data Deletion Requests</h1>
          To request data deletion, please contact
          <div className="flex space-x-4">
          <p className="link link-info">support@middleground.com.</p>
          <span className="text-secondary italic">Currently Inactive</span>
          </div>
          <span>If any data needs to be deleted, please contact a member from the team. Information is available in the "About" page.</span>
        </div>
        <Footer />
      </div>
    </div>
